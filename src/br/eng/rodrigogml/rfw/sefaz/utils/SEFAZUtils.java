...
import br.eng.rodrigogml.rfw.sefaz.vos.DetPagVO;
...
import br.eng.rodrigogml.rfw.sefaz.vos.InfAdicVO;
...
import br.eng.rodrigogml.rfw.sefaz.vos.PagVO;
...
public class SEFAZUtils {
   ...
   * @throws RFWException
   */
  public static NfeProcVO readXML(String xml) throws RFWException {
    ...
    nfeProcVO.setVersao(RUXML.getTextContent(doc, "/nfeProc/@versao"));
     ...
     */
    {
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/ide") != null) {
        ...
        ide.setTpNF(RUXML.getTextContent(doc, "/nfeProc/NFe/infNFe/ide/tpNF"));
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/emit") != null) {
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/dest") != null) {
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/det") != null) {
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/total") != null) {
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/transp") != null) {
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/cobr") != null) {
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/pag") != null) {
        PagVO pag = new PagVO();
        infNFe.setPag(pag);

        NodeList nodeList = RUXML.getNodeList(doc, "/nfeProc/NFe/infNFe/pag/detPag");
        if (nodeList.getLength() > 0) {
          List<DetPagVO> detPagList = new LinkedList<>();
          pag.setDetPag(detPagList);

          for (int i = 0; i < nodeList.getLength(); i++) {
            Node node = nodeList.item(i);

            DetPagVO detPag = new DetPagVO();
            detPagList.add(detPag);

            detPag.setIndPag(RUXML.getTextContent(node, "indPag"));
            detPag.setTpag(RUXML.getTextContent(node, "tPag"));
            detPag.setVpag(PreProcess.toBigDecimal(RUXML.getTextContent(node, "vPag")));
            detPag.setTpIntegra(RUXML.getTextContent(node, "card/tpIntegra"));
            detPag.setCnpj(RUXML.getTextContent(node, "card/CNPJ"));
            detPag.setTband(RUXML.getTextContent(node, "card/tBand"));
            detPag.setCaut(RUXML.getTextContent(node, "card/cAut"));
          }

          pag.setVtroco(PreProcess.toBigDecimal(RUXML.getTextContent(doc, "/nfeProc/NFe/infNFe/pag/vTroco")));
        }
      }
       ...
       */
      if (RUXML.getFirstNode(doc, "/nfeProc/NFe/infNFe/infAdic") != null) {
        InfAdicVO infAdic = new InfAdicVO();
        infNFe.setInfAdic(infAdic);

        infAdic.setInfAdFisco(RUXML.getTextContent(doc, "/nfeProc/NFe/infNFe/infAdic/infAdFisco"));
        infAdic.setInfCpl(RUXML.getTextContent(doc, "/nfeProc/NFe/infNFe/infAdic/infCpl"));
      }
    }
     ...
     * Tag ProtNFe
     */
    if (RUXML.getFirstNode(doc, "/nfeProc/protNFe") != null) {
      ProtNFeVO protNFe = new ProtNFeVO();
      nfeProcVO.setProtNFe(protNFe);

      protNFe.setVersao(RUXML.getTextContent(doc, "/nfeProc/protNFe/@versao"));

      protNFe.setIdAttribute(RUXML.getTextContent(doc, "/nfeProc/protNFe/infProt/@Id"));
      ...
      protNFe.setChNFe(RUXML.getTextContent(doc, "/nfeProc/protNFe/infProt/chNFe"));
