...
public class ICMSVO extends RFWVO {
   ...
   *
   * <h4>TAG N10a - ICMSPart</h4><br>
   * N12 CST Tributação do ICMS E N10a N 1-1 2
   * <li>10=Tributada e com cobrança do ICMS por substituição tributária;
   * <li>90=Outros
   *
   * <h4>TAG N10b - ICMSST</h4><br>
   * N12 CST Tributação do ICMS E N10b N 1-1 2<br>
   * <li>41=Não Tributado (v2.0).
   * <li>60= cobrado anteriormente por substituição tributária (Incluído NT2016.002)
   */
  ...
  /**
   * <h4>TAG N10c - ICMSSN101</h4><br>
   * N12a CSOSN Código de Situação da Operação – Simples Nacional E N10c N 1-1 3<br>
   * <li>101=Tributada pelo Simples Nacional com permissão de crédito. (v2.0)
   *
   * <h4>TAG N10d - ICMSSN102</h4><br>
   * N12a CSOSN Código de Situação da Operação – Simples Nacional E N10d N 1-1 3<br>
   * <li>102=Tributada pelo Simples Nacional sem permissão de crédito.
   * <li>103=Isenção do ICMS no Simples Nacional para faixa de receita bruta.
   * <li>300=Imune.
   * <li>400=Não tributada pelo Simples Nacional (v2.0) (v2.0)
   *
   * <h4>TAG N10e - ICMSSN201</h4><br>
   * N12a CSOSN Código de Situação da Operação – Simples Nacional E N10e N 1-1 3<br>
   * <li>201=Tributada pelo Simples Nacional com permissão de crédito e com cobrança do ICMS por Substituição Tributária (v2.0)
   *
   * <h4>TAG N10f - ICMSSN202</h4><br>
   * N11 orig Origem da mercadoria E N10f N 1-1 1 N12a CSOSN Código de Situação da Operação – Simples Nacional E N10f N 1-1 3
   * <li>202=Tributada pelo Simples Nacional sem permissão de crédito e com cobrança do ICMS por Substituição Tributária;
   * <li>203=Isenção do ICMS nos Simples Nacional para faixa de receita bruta e com cobrança do ICMS por Substituição Tributária (v2.0)
   *
   * <h4>TAG N10g - ICMSSN500</h4><br>
   * N12a CSOSN Código de Situação da Operação – Simples Nacional E N10g N 1-1 3<br>
   * <li>500=ICMS cobrado anteriormente por substituição tributária (substituído) ou por antecipação. (v2.0)
   *
   * <h4>TAG N10h - ICMSSN900</h4><br>
   * N12a CSOSN Código de Situação da Operação – SIMPLES NACIONAL E N10h N 1-1 3
   * <li>900=Outros (v2.0)
   */
   ...
   *
   * <h4>TAG N10a - ICMSPart</h4><br>
   * N13 modBC Modalidade de determinação da BC do ICMS E N10a N 1-1 1<br>
   * <li>0=Margem Valor Agregado (%)
   * <li>1=Pauta (Valor)
   * <li>2=Preço Tabelado Máx. (valor)
   * <li>3=Valor da operação
   ...
   *
   * <h4>TAG N10a - ICMSPart</h4><br>
   * N16 pICMS Alíquota do imposto E N10a N 1-1 3v2-4<br>
   * (v2.0)
   *
   * <h4>TAG N10h - ICMSSN900</h4><br>
   * N16 pICMS Alíquota do imposto E N12.1 N 1-1 3v2-4<br>
   ...
   *
   * <h4>TAG N10a - ICMSPart</h4><br>
   * N18 modBCST Modalidade de determinação da BC do ICMS ST E N10a N 1-1 1<br>
   * <li>0=Preço tabelado ou máximo sugerido
   * <li>1=Lista Negativa (valor)
   * <li>2=Lista Positiva (valor);
   * <li>3=Lista Neutra (valor)
   ...
   *
   * <h4>TAG N10e - ICMSSN201</h4><br>
   * N18 modBCST Modalidade de determinação da BC do ICMS ST E N10e N 1-1 1<br>
   * <li>0=Preço tabelado ou máximo sugerido
   * <li>1=Lista Negativa (valor)
   * <li>2=Lista Positiva (valor);
   * <li>3=Lista Neutra (valor)
   ...
   *
   * <h4>TAG N10f - ICMSSN202</h4><br>
   * N18 modBCST Modalidade de determinação da BC do ICMS ST E N10f N 1-1 1<br>
   * <li>0=Preço tabelado ou máximo sugerido
   * <li>1=Lista Negativa (valor)
   * <li>2=Lista Positiva (valor)
   * <li>3=Lista Neutra (valor)
   ...
   *
   * <h4>TAG N10a - ICMSPart</h4><br>
   * N20 pRedBCST Percentual da Redução de BC do ICMS ST E N10a N 0-1 3v2-4<br>
   * (v2.0)
   *
   * <h4>TAG N10e - ICMSSN201</h4><br>
   * N20 pRedBCST Percentual da Redução de BC do ICMS ST E N10e N 0-1 3v2-4<br>
   * (v2.0)
   *
   * <h4>TAG N10f - ICMSSN202</h4><br>
   * N20 pRedBCST Percentual da Redução de BC do ICMS ST E N10f N 0-1 3v2-4<br>
   * (v2.0)
   *
   * <h4>TAG N10h - ICMSSN900</h4><br>
   ...
   *
   * <h4>TAG N10a - ICMSPart</h4><br>
   * N22 pICMSST Alíquota do imposto do ICMS ST E N10a N 1-1 3v2-4<br>
   * (v2.0)
   *
   * <h4>TAG N10e - ICMSSN201</h4><br>
   * N22 pICMSST Alíquota do imposto do ICMS ST E N10e N 1-1 3v2-4<br>
   * Alíquota do ICMS ST sem o FCP. Quando for o caso, informar a alíquota do FCP no campo pFCP (Atualizado NT2016.002)
   *
   * <h4>TAG N10f - ICMSSN202</h4><br>
   * N22 pICMSST Alíquota do imposto do ICMS ST E N10f N 1-1 3v2-4<br>
   * Alíquota do ICMS ST sem o FCP. Quando for o caso, informar a alíquota do FCP no campo pFCP (Atualizado NT2016.002)
   *
   * <h4>TAG N10h - ICMSSN900</h4><br>
   * N22 pICMSST Alíquota do imposto do ICMS ST E N17.1 N 1-1 3v2-4<br>
   ...
   *
   * <h4>TAG N10a - ICMSPart</h4><br>
   * N14 pRedBC Percentual da Redução de BC E N10a N 0-1 3v2-4<br>
   * (v2.0)
   *
   * <h4>TAG N10h - ICMSSN900</h4><br>
   ...
   *
   * <h4>TAG N10b - ICMSST</h4><br>
   * N26a pST Alíquota suportada pelo Consumidor Final E N10b N 0-1 3v2-4<br>
   * Deve ser informada a alíquota do cálculo do ICMS-ST, já incluso o FCP caso incida sobre a mercadoria. Exemplo: alíquota da mercadoria na venda ao consumidor final = 18% e 2% de FCP.<br>
   * A alíquota a ser informada no campo pST deve ser 20%. (Criado na NT 2018.005 v1.10. Atualizado na 2018.005 v1.20)
   *
   * <h4>TAG N10g - ICMSSN500</h4><br>
   * N26a pST Alíquota suportada pelo Consumidor Final E N25.1 N 1-1 3v2-4<br>
   ...
   *
   * <h4>TAG N10b - ICMSST</h4><br>
   * N26b vICMSSubstituto Valor do ICMS próprio do Substituto E N10b N 0-1 13v2<br>
   ...
   * <h4>TAG N10b - ICMSST</h4><br>
   * N27a vBCFCPSTRet Valor da Base de Cálculo do FCP retido anteriormente E N27.1 N 1-1 13v2<br>
   * Informar o valor da Base de Cálculo do FCP retido anteriormente por ST (Criado na NT 2018.005)
   *
   * <h4>TAG N10g - ICMSSN500</h4><br>
   * N27a vBCFCPSTRet Valor da Base de Cálculo do FCP retido anteriormente E N27.1 N 1-1 13v2<br>
   * Informar o valor da Base de Cálculo do FCP retido anteriormente por ST
   ...
   * <h4>TAG N10b - ICMSST</h4><br>
   * N27b pFCPSTRet Percentual do FCP retido anteriormente por Substituição Tributária E N27.1 N 1-1 3v2-4<br>
   * Percentual relativo ao Fundo de Combate à Pobreza (FCP) retido por substituição tributária. (Criado na NT 2018.005)
   *
   * <h4>TAG N10g - ICMSSN500</h4><br>
   * N27b pFCPSTRet Percentual do FCP retido anteriormente por Substituição Tributária E N27.1 N 1-1 3v2-4<br>
   * Percentual relativo ao Fundo de Combate à Pobreza (FCP)
   ...
   * <h4>TAG N10b - ICMSST</h4><br>
   * N27d vFCPSTRet Valor do FCP retido por Substituição Tributária E N27.1 N 1-1 13v2<br>
   * Valor do ICMS relativo ao Fundo de Combate à Pobreza (FCP) retido por substituição tributária.} (Criado na NT 2018.005)
   *
   * <h4>TAG N10g - ICMSSN500</h4><br>
   ...
   * <h4>TAG N10b - ICMSST</h4><br>
   * N34 pRedBCEfet Percentual de redução da base de cálculo efetiva E N33 N 1-1 3v2-4<br>
   * Percentual de redução, caso estivesse submetida ao regime comum de tributação, para obtenção da base de cálculo efetiva (vBCEfet). Obs.: opcional a critério da UF. (Criado na NT 2018.005 v1.10)
   *
   * <h4>TAG N10g - ICMSSN500</h4><br>
   * N34 pRedBCEfet Percentual de redução da base de cálculo efetiva E N33 N 1-1 3v2-4<br>
   * Percentual de redução, caso estivesse submetida ao regime comum de tributação, para obtenção da base de cálculo efetiva (vBCEfet). <br>
  ...
  /**
   * <h4>TAG N10a - ICMSPart</h4><br>
   * N24 UFST UF para qual é devido o ICMS ST E N10a C 1-1 2<br>
   * Sigla da UF para qual é devido o ICMS ST da operação. Informar "EX" para Exterior. (v2.0)
   */
  @RFWMetaStringField(caption = "UF Para Qual é Devido o ICMS ST", minlength = 2, maxLength = 2, required = false, pattern = "^(EX|AC|AL|AP|AM|BA|CE|DF|ES|GO|MA|MG|MS|MT|PA|PB|PE|PI|PR|RJ|RN|RO|RR|RS|SC|SE|SP|TO)$")
  ...
  /**
   * <h4>TAG N10c - ICMSSN101</h4><br>
   * N29 pCredSN Alíquota aplicável de cálculo do crédito (Simples Nacional). E N10c N 1-1 3v2-4<Br>
   * (v2.0)
   *
   * <h4>TAG N10e - ICMSSN201</h4><br>
   * N29 pCredSN Alíquota aplicável de cálculo do crédito (SIMPLES NACIONAL). E N10e N 1-1 3v2-4<br>
  ...
  /**
   * <h4>TAG N10c - ICMSSN101</h4><br>
   * N30 vCredICMSSN Valor crédito do ICMS que pode ser aproveitado nos termos do art. 23 da LC 123 (Simples Nacional) E N10c N 1-1 13v2<br>
   * (v2.0)
   *
   * <h4>TAG N10e - ICMSSN201</h4><br>
   * N30 vCredICMSSN Valor crédito do ICMS que pode ser aproveitado nos termos do art. 23 da LC 123 (SIMPLES NACIONAL) E N10e N 1-1 13v2<Br>
   * (v2.0) (Atualizado NT2016.002)
   *
   * <h4>TAG N10h - ICMSSN900</h4><br>
   ...
   *         <h4>TAG N10c - ICMSSN101</h4><br>
   *         N12a CSOSN Código de Situação da Operação – Simples Nacional E N10c N 1-1 3<br>
   *         <li>101=Tributada pelo Simples Nacional com permissão de crédito
   */
   ...
   * @return #
   *         <h4>TAG N02 - ICMS00</h4><br>
   *         N17b pFCP Percentual do ICMS relativo ao Fundo de Combate à Pobreza (FCP) E N17
   */
   ...
   * @return #
   *         <h4>TAG N02 - ICMS00</h4><br>
   *         N17c vFCP Valor do Fundo de Combate à Pobreza (FCP) E N17
   */
   ...
   *         N20 pRedBCST Percentual da Redução de BC do ICMS ST E N09 N 0-1 3v2-4
   *         <h4>TAG N10 - ICMS90</h4><br>
   *         N20 pRedBCST Percentual da Redução de BC do ICMS ST E N17
   */
   ...
   * @return #
   *         <h4>TAG N03 - ICMS10</h4><br>
   *         N23a vBCFCPST Valor da Base de Cálculo do FCP retido por Substituição Tributária E N23
   */
   ...
   * @return #
   *         <h4>TAG N03 - ICMS10</h4><br>
   *         N23b pFCPST Percentual do FCP retido por Substituição Tributária E N23
   */
   ...
   * @return #
   *         <h4>TAG N03 - ICMS10</h4><br>
   *         N23d vFCPST Valor do FCP retido por Substituição Tributária E N23
   */
   ...
   *         N14 pRedBC Percentual da Redução de BC E N09 N 1-1 3v2-4
   *         <h4>TAG N10 - ICMS90</h4><br>
   *         N14 pRedBC Percentual da Redução de BC E N12
   */
   ...
   * @return #
   *         <h4>TAG N04 - ICMS20</h4><br>
   *         N28 motDesICMS Motivo da desoneração do ICMS E N27
   */
   ...
   * @return #
   *         <h4>TAG N08 - ICMS60</h4><br>
   *         N26a pST Alíquota suportada pelo Consumidor Final E N25
   */
   ...
   * @return #
   *         <h4>TAG N08 - ICMS60</h4><br>
   *         N26b vICMSSubstituto Valor do ICMS próprio do Substituto E N25
   */
   ...
   * @return #
   *         <h4>TAG N08 - ICMS60</h4><br>
   *         N27a vBCFCPSTRet Valor da Base de Cálculo do FCP retido anteriormente E N27
   */
   ...
   * @return #
   *         <h4>TAG N08 - ICMS60</h4><br>
   *         N27b pFCPSTRet Percentual do FCP retido anteriormente por Substituição Tributária E N27
   */
   ...
   * @return #
   *         <h4>TAG N08 - ICMS60</h4><br>
   *         N27d vFCPSTRet Valor do FCP retido por Substituição Tributária E N27
   */
   ...
   * @return #
   *         <h4>TAG N10c - ICMSSN101</h4><br>
   *         N30 vCredICMSSN Valor crédito do ICMS que pode ser aproveitado nos termos do art
   */
