...
public class SEFAZ {
   ...
   * @throws RFWException
   */
  public SEFAZ(RFWCertificate cert, RFWCertificate trustCert, SefazXMLUF uf, SefazXMLtpAmb env) throws RFWException {
    PreProcess.requiredNonNull(uf);
  ...
  public TRetConsCad consultaCadastroV200(TConsCad root) throws RFWException {
    ...
    CadConsultaCadastro4Stub stub = createCadConsultaCadastro4Stub(env, uf, contingency);
  ...
  public TRetEnviNFe nfeAutorizacaoLoteV400(TEnviNFe root) throws RFWException {
    ...
    NFeAutorizacao4Stub stub = createNFeAutorizacao4Stub(env, uf, contingency);
  ...
  public TRetConsReciNFe nfeRetAutorizacaoV400(TConsReciNFe root) throws RFWException {
    ...
    NFeRetAutorizacao4Stub stub = createNFeRetAutorizacao4Stub(env, uf, contingency);
  ...
  private TConsCad createConsCadV200Message(String cpf, String cnpj, String ie) throws RFWException {
    ...
    root.getInfCons().setUF(TUfCons.valueOf(uf.getAcronym()));
   ...
   * @param uf Servidor para conexão.
   * @param contingency Método de contingência ou null para nenhuma contingência.
   * @return Stub pronto para conexão.
   * @throws RFWException
   */
  private CadConsultaCadastro4Stub createCadConsultaCadastro4Stub(SefazXMLtpAmb env, SefazXMLUF uf, SefazContingency contingency) throws RFWException {
    CadConsultaCadastro4Stub stub = null;
    try {
      if (env.equals(SefazXMLtpAmb.PRODUCTION)) {
        if (uf.equals(SefazXMLUF.SP)) {
          if (contingency == null) {
            stub = new CadConsultaCadastro4Stub(SEFAZDefinitions.SP_PRODUCTION_V4_00_CADCONSULTACADASTRO4);
          } else {
            throw new RFWCriticalException("RFW_000035", new String[] { env.toString(), uf.toString(), "" + contingency });
          }
        }
      ...
      throw new RFWCriticalException("Falha ao criar Stub para o ambiente '${0}', UF '${1}', contingência: '${2}'.", new String[] { env.toString(), uf.toString(), "" + contingency }, e);
    }
    if (stub == null) {
      throw new RFWCriticalException("Falha ao criar Stub para o ambiente '${0}', UF '${1}', contingência: '${2}'.", new String[] { env.toString(), uf.toString(), "" + contingency });
    }
   ...
   * @throws RFWException
   */
  private NFeAutorizacao4Stub createNFeAutorizacao4Stub(SefazXMLtpAmb env, SefazXMLUF uf, SefazContingency contingency) throws RFWException {
   ...
   * @throws RFWException
   */
  private NFeRetAutorizacao4Stub createNFeRetAutorizacao4Stub(SefazXMLtpAmb env, SefazXMLUF uf, SefazContingency contingency) throws RFWException {
