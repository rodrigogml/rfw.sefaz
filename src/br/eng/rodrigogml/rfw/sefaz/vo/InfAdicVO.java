...
public class InfAdicVO extends RFWVO {
  ...
  private List<ObsContVO> obsCont;
  ...
  private List<ObsFiscoVO> obsFisco;
  ...
  private List<ProcRefVO> procRef;
   ...
   */
  public List<ObsContVO> getObsCont() {
    return obsCont;
  }
   ...
   */
  public void setObsCont(List<ObsContVO> obsCont) {
   ...
   */
  public List<ObsFiscoVO> getObsFisco() {
    return obsFisco;
  }
   ...
   */
  public void setObsFisco(List<ObsFiscoVO> obsFisco) {
   ...
   */
  public List<ProcRefVO> getProcRef() {
    return procRef;
  }
   ...
   */
  public void setProcRef(List<ProcRefVO> procRef) {
