...
@XmlRootElement(name = "retConsSitNFe", namespace = "http://www.portalfiscal.inf.br/nfe")
public class TRetConsSitNFe {
   ...
   *
   * @param value allowed object is {@link TRetCancNFe }
   *
   */
   ...
   *
   * <p>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the procEventoNFe property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link TProcEvento }
   *
   *
   */
