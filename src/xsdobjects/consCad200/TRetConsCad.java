...
public class TRetConsCad {
   ...
   * 
   * @param value allowed object is {@link TRetConsCad.InfCons }
   * 
   */
  ...
  public static class InfCons {
     ...
     * 
     * @param value allowed object is {@link TUfCons }
     * 
     */
     ...
     * 
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the infCad property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TRetConsCad.InfCons.InfCad }
     * 
     * 
     */
